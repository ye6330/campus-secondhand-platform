package com.campus.secondhand.order.entity;
...
public class Order {
    ...
    private LocalDateTime tradeConfirmedAt;
    ...
    public LocalDateTime getTradeConfirmedAt() { return tradeConfirmedAt; }
    public void setTradeConfirmedAt(LocalDateTime tradeConfirmedAt) { this.tradeConfirmedAt = tradeConfirmedAt; }
